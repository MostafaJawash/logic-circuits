...
import { List, ChevronDown, GraduationCap } from "lucide-react";
...
export function Chapter1Content() {
  ...
  return (
    <>
      ...
      {/* نسبة القراءة */}
      <div className="fixed bottom-5 left-5 z-40 hidden items-center gap-2 rounded-full glass px-4 py-2 text-sm font-bold text-accent shadow-lg sm:flex">
